...
const Index = () => {
  ...
  const renderTrendingItem = useCallback<ListRenderItem<TrendingMovie>>(
    ({ item, index }) => <TrendingCard movie={item} index={index} />,
    [],
  );
          ...
          <View className="flex-1 mt-5">
            ...
            <>
              ...
              <FlatList
                ...
                accessibilityHint="Scroll to view more popular movies"
              />
            </>
          </View>
        )}
